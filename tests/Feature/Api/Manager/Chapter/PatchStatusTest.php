...
class PatchStatusTest extends TestCase
{
    ...
    public function test_チャプターのステータス変更_成功(): void
    {
        ...
        // act
        $response = $this->patchJson('/api/v1/manager/course/1/chapter/status', [
            'chapters' => [1, 2],
            'status' => 'private',
        ]);
    ...
    public function test_講座が一致しない_失敗(): void
    {
        ...
        // act
        $response = $this->patchJson('/api/v1/manager/course/2/chapter/status', [
            'chapters' => [1, 2],
            'status' => 'private',
        ]);
    ...
    public function test_バリデーションエラー(): void
    {
        ...
        // act
        $response = $this->patchJson('/api/v1/manager/course/aaa/chapter/status', [
            'chapters' => 'string',
            'status' => 'string',
        ]);

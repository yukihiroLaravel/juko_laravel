...
class BulkDeleteTest extends TestCase
{
    ...
    public function test_チャプターの一括削除_成功(): void
    {
        ...
        // act
        $response = $this->deleteJson('/api/v1/manager/course/5/chapter', [
            'chapters' => [6],
        ]);
    ...
    public function test_講座が一致しない_失敗(): void
    {
        ...
        // act
        $response = $this->deleteJson('/api/v1/manager/course/2/chapter', [
            'chapters' => [6],
        ]);
    ...
    public function test_受講している_失敗(): void
    {
        ...
        // act
        $response = $this->deleteJson('/api/v1/manager/course/1/chapter', [
            'chapters' => [1],
        ]);
    ...
    public function test_バリデーションエラー(): void
    {
        ...
        // act
        $response = $this->deleteJson('/api/v1/manager/course/aaa/chapter', [
            'chapters' => [],
        ]);
